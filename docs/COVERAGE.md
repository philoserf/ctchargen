...
| A record names the policy that answered it, and the document says so too      | JSON conventions | `chargen.PolicyVersion`                    | `docsgate.TestThePolicyVersionMatchesTheDocument`, `chargen.TestGoldens`                                |
