...
| A batch to standard output arrives a record at a time                         | CLI sketch       | `cmd/ctchargen.streamed`                   | `ctchargen.TestABatchToStandardOutputArrivesARecordAtATime`                                       |
...
| A write that fails partway stops the batch, naming the member                 | CLI sketch       | `cmd/ctchargen.streamed`                   | `ctchargen.TestABatchReportsAWriteThatFailedPartway`                                              |
